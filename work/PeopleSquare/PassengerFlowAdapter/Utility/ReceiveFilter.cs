...
namespace Utility
{
    ...
    public abstract class SubFixedHeaderReceiveFilter<TRequestInfo> : FixedSizeReceiveFilter<TRequestInfo>
        where TRequestInfo : IRequestInfo
    {
        ...
        protected SubFixedHeaderReceiveFilter(int headerSize)
            : base(headerSize)
        {
    ...
    //public class ReceiveFilter<TRequestInfo>:IReceiveFilter<TRequestInfo>,IOffsetAdapter
    //    where TRequestInfo :IRequestInfo
    //{
    //    private ArraySegmentList m_BodyBuffer;
    //    int nReadLen = 0;
    ...
    //            if(nBufLen<=0)
    //            {
    //                m_BodyBuffer.AddSegment(readBuffer, offset, length,true);
    //                nOffset = 0;
    //                nBufLen = m_BodyBuffer.Count;
