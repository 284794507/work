    ...
    public class DevReceiveFilter:FixedHeaderReceiveFilter<BinaryRequestInfo>
    {
        ...
        protected override BinaryRequestInfo ResolveRequestInfo(ArraySegment<byte> header, byte[] bodyBuffer, int offset, int length)
        {
            ...
            AspectF.Define.Retry(Share.Instance.CatchExpection, (() => {
                Share.Instance.LogInfo("DEV:ResolveRequestInfo");
            }))
                .Do(() =>
                {
                    ...
                    Share.Instance.WriteMsg("Receive from Dev，ID：" + PackageHelper.GetPackageHelper.GetAddressFromXNProtocol(data), 2);
            ...
            //Buffer.BlockCopy(header.Array, header.Offset, data, 0, headLen);
            //Buffer.BlockCopy(bodyBuffer, offset, data, headLen, length);
            //Share.Instance.WriteMsg(bodyBuffer.Length.ToString() + " # " + offset.ToString() + " # " + length.ToString(), 2);
